...
import OpsIntelligence from '../ops-intelligence/ops-intelligence'
import '../../common/fs.js'
...
export default auto(function Index (props) {
  ...
  const opsIntelligenceProps = {
    rightPanelTab,
    opsCommandEvents: deepCopy(store.opsCommandEvents),
    opsInsights: deepCopy(store.opsInsights),
    opsKnowledge: deepCopy(store.opsKnowledge),
    opsAutoCapture: store.opsAutoCapture,
    opsPanelSection: store.opsPanelSection,
    opsSummaryPending: store.opsSummaryPending
  }
  return (
    <ConfigProvider
      theme={uiThemeConfig}
    >
      <div {...ext1}>
        ...
        <RightSidePanel {...rightPanelProps}>
          ...
          <OpsIntelligence {...opsIntelligenceProps} />
        </RightSidePanel>
