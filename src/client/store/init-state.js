...
import { getOpsAutoCaptureDefault } from './ops-intelligence'
...
export default () => {
  ...
  return {
    ...
    // TermMind local-first operations intelligence
    opsCommandEvents: [],
    opsInsights: [],
    opsKnowledge: [],
    opsAutoCapture: getOpsAutoCaptureDefault(),
    opsPanelSection: 'diagnosis',
    opsSummaryPending: false,
